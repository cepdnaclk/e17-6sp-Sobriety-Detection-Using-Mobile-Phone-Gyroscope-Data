...
const acceleroReadingsSchema = new mongoose.Schema({
    readings: [{data: {x: String, y: String, z: String}, timeStamp: String}],
...
}, {collection: 'acceleroReadings'});

module.exports = mongoose.model('acceleroReadingsModel', acceleroReadingsSchema);